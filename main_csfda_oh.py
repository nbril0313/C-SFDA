...
from target_domainnet_126 import train_target_domain as train_target_csfda
from utils import configure_logger, NUM_CLASSES, use_wandb
import warnings
warnings.filterwarnings('ignore')
NCCL_P2P_DISABLE=1

@hydra.main(version_base="1.1", config_path="configs_oh", config_name="root")
def main(args):
